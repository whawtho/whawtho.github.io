...
public class ContactTest {
    ...
    //Enhancement
    @Test
    public void testSearchByFirstNameSuccess() {
        ContactService service = new ContactService();
        service.addContact(new Contact("1", "John", "Doe", "5555555555", "123 Main"));

        List<Contact> results = service.searchByName("John");
    ...
    public void testSearchReturnsEmptyWhenNoMatch() {
        ...
        List<Contact> results = service.searchByName("Bob");
